...
if __name__ == '__main__':
    plot_figure([x_k, x_k], [y_all, y_dhg], ['complete model', 'remove HGC'], np.arange(.78, .86, .01), 'k', 'remove_hgc.png')
    plot_figure([x_k, x_k], [y_all, y_hgc], ['complete model', 'remove DHG'], np.arange(.79, .84, .01), 'k', 'remove_dhg.png')
